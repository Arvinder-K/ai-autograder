    ...
    <div class="app-shell" x-data="{ sidebarOpen: false }">
            ...
            <div class="flex items-center gap-4" x-data="{ open: false }">
                <button @click="open = !open"
                    ...
                    <?php if(Auth::user()->avatar): ?>
                        <img src="<?php echo e(Auth::user()->avatar); ?>" alt="" class="w-8 h-8 rounded-full">
                    <?php else: ?>
                        <div
                    ...
                    <?php endif; ?>
                    <span class="text-body-sm hidden md:inline"><?php echo e(Auth::user()->name); ?></span>
                ...
                <div x-show="open" @click.away="open = false" x-transition
                    ...
                    <div class="px-4 py-2 border-b border-border-subtle">
                        <p class="text-body-sm font-medium text-txt-primary"><?php echo e(Auth::user()->name); ?></p>
                        <p class="text-caption text-txt-muted"><?php echo e(Auth::user()->email); ?></p>
                    </div>
                    <a href="<?php echo e(route('dashboard')); ?>"
        ...
        <aside id="sidebar" class="sidebar transition-transform lg:translate-x-0 -translate-x-full">
            <nav class="flex-1 p-4 space-y-1">
                ...
                <a href="<?php echo e(route('ai.evaluator')); ?>"
                    class="nav-item <?php echo e(request()->routeIs('ai.evaluator*') ? 'active' : ''); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <?php if(Auth::user()->isAdmin()): ?>
                    ...
                    <a href="<?php echo e(route('admin.stories.index')); ?>"
                        class="nav-item <?php echo e(request()->routeIs('admin.stories.*') ? 'active' : ''); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="<?php echo e(route('admin.config.index')); ?>"
                        class="nav-item <?php echo e(request()->routeIs('admin.config.*') ? 'active' : ''); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="<?php echo e(route('admin.audit.index')); ?>"
                        class="nav-item <?php echo e(request()->routeIs('admin.audit.*') ? 'active' : ''); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="<?php echo e(route('admin.analytics.index')); ?>"
                        class="nav-item <?php echo e(request()->routeIs('admin.analytics.*') ? 'active' : ''); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<?php /**PATH C:\xampp\htdocs\storyforge\storyforge\resources\views/components/layouts/app.blade.php ENDPATH**/ ?>