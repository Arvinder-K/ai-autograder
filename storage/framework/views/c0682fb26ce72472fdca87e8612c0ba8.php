...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Prompt Generator','apiStatus' => $apiStatus ?? null]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Prompt Generator'),'apiStatus' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($apiStatus ?? null)]); ?>
    <div class="page-body max-w-5xl mx-auto flex flex-col gap-8">
        <div class="bg-white/95 backdrop-blur-xl border border-white/20 shadow-[0_8px_30px_rgb(0,0,0,0.04)] w-full p-8 rounded-[32px]">
            ...
            <form method="POST" action="<?php echo e(route('prompt.generator.generate')); ?>" enctype="multipart/form-data" 
                  x-data="{ 
                      loading: false, 
                      progress: 0, 
            ...
            <?php if(session('generated_prompt')): ?>
                <div class="mt-10 border-t border-gray-100 pt-8" x-data="{ 
                    ...
                    <div class="mb-6">
                        <textarea id="generated_prompt_text" class="w-full h-96 p-4 border border-gray-200 rounded-xl bg-gray-50 text-sm font-mono focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none" spellcheck="false" readonly><?php echo e(session('generated_prompt')); ?></textarea>
                    ...
                    <div x-show="saveSuccess" class="mt-3 text-sm text-emerald-600 bg-emerald-50 p-3 rounded-lg border border-emerald-100" style="display: none;" x-transition>
                        Successfully saved! You can now use this prompt in the <a href="<?php echo e(route('ai.evaluator')); ?>" class="font-bold underline">AI Evaluator</a>.
                    </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\AiAutoGrader - Final\resources\views/prompt-generator/index.blade.php ENDPATH**/ ?>